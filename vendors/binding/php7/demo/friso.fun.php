...
echo "complex mode: ".FRISO_COMPLEX.", simple mode: ".FRISO_SIMPLE." \n";
echo "friso_ucode_utf8(20013)=".friso_ucode_utf8(20013)."\n";
echo "friso_utf8_ucode(中)=".friso_utf8_ucode("中")."\n";
echo "friso_utf8_bytes(中)=".friso_utf8_bytes("中")."\n\n";

echo "词库函数：\n";
echo "friso_dic_exist(研究) ? ".friso_dic_exist(FRISO_LEX_CJK, "研究")."\n\n";

$_entry = friso_dic_get(FRISO_LEX_CJK, "研究");
echo "friso_dic_get(研究)：\n";
echo "|——length: ".$_entry["length"].", freq: ".$_entry["freq"]."\n\n";

//version about.
echo "friso_version(): " , friso_version(), ", friso_charset(): ", friso_charset(), "\n\n";
